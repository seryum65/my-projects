...
aws ec2 run-instances --image-id $LATEST_AMI --count 1 --instance-type t2.micro --key-name xxxxxxx --security-groups roman_numbers_sec_grp --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=roman_numbers}]' --user-data file:///home/seryum65/Desktop/AWS Devops/AWS/my-projects/AWS/Project-001-Roman-Numerals-Converter/userdata.sh
